...
# forward 2 adds 2 to your horizontal position, a total of 15. Because your aim is 10, your depth increases by 2*10=20 to 
# a total of 60.
...
for instruction in instructions:
    ...
    #If it is forward, move horizontal for given amount, and move depth for aim times given amount
    if instructionName == "forward":
        horizontal += move
        depth += aim*move
    #If it is down increase aim for given amount
    elif instructionName == "down":
        aim += move
    #Else it must be up, and then decrease aim for given amount
    else:
        aim-= move
