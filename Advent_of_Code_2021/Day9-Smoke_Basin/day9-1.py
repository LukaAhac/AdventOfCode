...
# Most locations have four adjacent locations (up, down, left, and right); locations on the edge or corner of the 
# map have three or two adjacent locations, respectively. (Diagonal locations do not count as adjacent.)
...
for y in range(len(inp)):
    ...
    for x in range(len(inp[0])):
        ...
        if lowPoint:
            riskLevelSum += 1
            riskLevelSum += inp[y][x]

#Output
print("The sum of the risk levels of all low points on the heightmap is :",riskLevelSum)