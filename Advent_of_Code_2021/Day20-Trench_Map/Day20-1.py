...
# ..#..
# ..###
# The first section is the image enhancement algorithm. It is normally given on a single line, but it has 
# been wrapped to multiple lines in this example for legibility. The second section is the input image, a 
# two-dimensional grid of light pixels (#) and dark pixels (.).

# The image enhancement algorithm describes how to enhance an image by simultaneously converting all pixels 
# in the input image into an output image. Each pixel of the output image is determined by looking at a 3x3 
# square of pixels centered on the corresponding input image pixel. So, to determine the value of the pixel 
# at (5,10) in the output image, nine pixels from the input image need to be considered: (4,9), (4,10), (4,11), 
# (5,9), (5,10), (5,11), (6,9), (6,10), and (6,11). These nine input pixels are combined into a single binary 
# number that is used as an index in the image enhancement algorithm string.
...
# |         |         |         |   |     |         |         |         |
# ..#.#..#####.#.#.#.###.##.....###.##.#..###.####..#####..#....#..#..##..##
# In the middle of this first group of characters, the character at index 34 can be found: #. So, the output pixel 
# in the center of the output image should be #, a light pixel.
...
# the infinite output image needs to be calculated exactly based on the relevant pixels of the input image. 
# The small input image you have is only a small region of the actual infinite input image; the rest of the input 
# image consists of dark pixels (.). For the purposes of the example, to save on space, only a portion of the 
...
# ...............
# ...............
# Truly incredible - now the small details are really starting to come through. After enhancing the original 
# input image twice, 35 pixels are lit.
